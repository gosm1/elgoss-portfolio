...
const MagicButton = ({title,icon,position,handleClick,otherClasses,downloadLink,}:
    {
    title:string,
    ...
    return (
        <div className="my-5">
            <a href='/elgossmouhcine_cv.pdf' target="_blank" rel="noopener noreferrer" download >
